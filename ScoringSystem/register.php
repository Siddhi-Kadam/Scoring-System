...
<head>
    ...
    <link rel="shortcut icon" href="http://soteris.com.au/media/STS-Infinity.png">
    <!-- Font Icon -->
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="registration.php">
                            ...
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="status" id="status" placeholder="Your Status i.e. teacher/student"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="index.html" class="signup-image-link">Already member</a>
                    </div>
                </div>
            </div>
        </section>
